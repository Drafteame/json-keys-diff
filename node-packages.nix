...
in
{
  json-keys-diff = nodeEnv.buildNodePackage {
    ...
    version = "0.0.8";
    src = fetchurl {
      url = "https://registry.npmjs.org/json-keys-diff/-/json-keys-diff-0.0.8.tgz";
      sha512 = "FWIYHO7Jwgg8l1+u/dZrDvlw+oAh0mYhAa0ki8MRlWbunSfbfu1XLR28xd0EPdYZnCFvdmgN0bVLOqID5zj80g==";
    };
    dependencies = [
