...
in
{
  json-keys-diff = nodeEnv.buildNodePackage {
    ...
    version = "0.0.3";
    src = fetchurl {
      url = "https://registry.npmjs.org/json-keys-diff/-/json-keys-diff-0.0.3.tgz";
      sha512 = "67ViHClldsjrluoJy9ltmEeBcEINNfpF6bo5W7nZ9nROk8uMsPqkpe085cxZ6SiqBjzj+qvujLI32oorxKG9fA==";
    };
    dependencies = [
